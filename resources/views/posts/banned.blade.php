        ...
        @if (Session::has('isBanned'))
            <div id="alert-additional-content-2" class="p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200" role="alert">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-medium text-red-700 dark:text-red-800"> {!! \Session::get('isBanned') !!}</h3>
                </div>
                <div class="mt-2 mb-4 text-sm text-red-700 dark:text-red-800">
                    Aktivitas anda telah melanggar aturan komunitas.
                </div>
                <div class="flex">
